...
import type { Bird, ExtractedPedigree, PedigreeProse } from '../../shared/types.js';
 ...
 */
export async function extractPedigree(file: SourceFile): Promise<ExtractedPedigree> {
  ...
  for (const b of parsed.birds) idMap.set(b.localId, randomUUID());
